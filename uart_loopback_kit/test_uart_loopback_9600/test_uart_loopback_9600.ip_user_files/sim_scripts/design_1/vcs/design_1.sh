...
#
# Generated by Vivado on Mon Jun 12 21:46:32 JST 2017
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../test_uart_loopback_9600.srcs/sources_1/bd/design_1/ipshared/100a" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../test_uart_loopback_9600.srcs/sources_1/bd/design_1/ipshared/100a" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/yosimoto/u-tokyo/hardware-lab/test_uart_loopback_9600/test_uart_loopback_9600.cache/compile_simlib/vcs"
  fi
