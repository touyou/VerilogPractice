...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../eval_datamover_axi_ic.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl" \
       +incdir+"../../../../eval_datamover_axi_ic.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl"
}
