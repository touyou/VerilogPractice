...
set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { ledtrig }]; #IO_L18N_T2_35 Sch=led0_b
...
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { ledcyc }]; #IO_L23P_T3_35 Sch=led3_b
