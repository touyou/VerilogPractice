...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../eval_datamover_axi_impl.srcs/sources_1/bd/design_1/ipshared/100a" \
       +incdir+"../../../../eval_datamover_axi_impl.srcs/sources_1/bd/design_1/ipshared/100a"
}
