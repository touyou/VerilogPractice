...
HD_PWD='/home/tansei/Desktop/hardware_kadai/verilog/Task8/test/test.runs/design_1_fadd_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fadd_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fadd_0_0.tcl
